...
public class Triangle implements Shape {
    ...
    private double getLengthSide(double x1, double x2, double y1, double y2) {
    ...
    public int hashCode() {
        final int prime = 37;
        return prime + Double.hashCode(x1) + Double.hashCode(x2) + Double.hashCode(x3) + Double.hashCode(y1)
                + Double.hashCode(y2) + Double.hashCode(y3);
    }
}